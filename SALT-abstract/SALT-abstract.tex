...
{\bf Discussion: Novel research question.}
	...
	%
	For \emph{announce, confess, admit}, and \emph{reveal}, the CC is most projective when embedded in the antecedent of a conditional: This {\bf `Conditional high'} pattern, shown in (c), may suggest that the discourse effect of a conditional interacts with the change-of-state communication predicates.
	%

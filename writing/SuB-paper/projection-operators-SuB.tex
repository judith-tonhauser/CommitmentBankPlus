...
\section{Experiments}\label{s2}
    ...
    %This diagnostic was also used in \citealt{sieker_projective_2022}.
	...
	\subsection{Methods}
        ...
        \paragraph{Participants.}
            ...
            \begin{figure}[h!]
				\centering
				\fbox{\includegraphics[width = .6\linewidth]{task-1n-proj.eps}}
...
\end{table}
        ...
        % \mcdm{does it make sense to compare different predicates?}

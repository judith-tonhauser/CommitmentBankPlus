...
The control stimuli in Exps.~1-3 were main clauses. For the question embedding (Exps.~1q, 2q and 3q), we used the polar questions in (2). The NRRCs in parentheses are only used in Exps.~2q and 3q to make the use of the assent diagnostics in the at-issueness blocks more natural: like the target stimuli, the control stimuli consist of two clauses, one of which the relevant speaker assents with.

\begin{exe}
\exi{(1)} Sentences for control stimuli in question embedding (Exps.~1q, 2q and 3q)
\begin{xlist}
...
\paragraph{Expectations of answers to certainty and at-issueness diagnostics} For the control stimuli in (1) used in Exps.~1q, 2q and 3q, which are polar questions, we expected participants to give low responses in the `certain that' diagnostic, indicating that the speaker is not certain of the main clause content, i.e., that the content does not project out of the question. For the control stimuli in (2), which are positive declarative sentences, we expected high responses in the `certain that' diagnostic for the control stimuli, indicating that the speaker is certain of the main clause content. These expectations were borne out, as shown in the third column of Table~\ref{t-controls}.

%In Exps.~2 and 3, the NRRCs were included in all control stimuli: the carrier sentences were the polar question variants of the sentences in (1) in Exps.~2q and 3q, and the sentences in (1) for the remaining experiments. 
...
Experiment & Control stimuli & Certainty &  \multicolumn{2}{l}{At-issueness} \\ & & Mean rating & Mean rating & Measure \\ 
\hline
...
For the at-issueness diagnostics, we expected the main clause content to be at-issue across the diagnostics. We thus expected low responses across all at-issueness diagnostics, given that participants' responses were coded so that the higher a participants' response, the more not-at-issue the content was hypothesized to be (since we investigate whether there is a positive correlation between projection and not-at-issueness). However, as shown in the fourth column of Table~\ref{t-proj-controls}, the at-issueness ratings are not always low. In particular, xx 


Exp.~3q\\
A: Do these muffins, which are really delicious, have blueberries in them?\\
B: Yes, but they aren't really delicious.

Exp.~2n, 2m, 2c\\
A: These muffins, which are really delicious, have blueberries in them.\\
B: Yes, that's true, they have blueberries in them.

Exp.~3n, 3m, 3c\\
A: These muffins, which are really delicious, have blueberries in them.\\
B: Yes, that's true, but they aren't really delicious.

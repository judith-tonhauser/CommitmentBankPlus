...
\hlstd{> }\hlstd{data}\hlopt{$}\hlstd{verb} \hlkwb{<-} \hlkwd{relevel}\hlstd{(data}\hlopt{$}\hlstd{verb,} \hlkwc{ref} \hlstd{=} \hlstr{"prove"}\hlstd{)}
\hlstd{> }
\hlstd{> }\hlcom{### dummy coding for "op" with "n" as baseline}
\hlstd{> }\hlstd{data}\hlopt{$}\hlstd{op} \hlkwb{<-} \hlkwd{relevel}\hlstd{(data}\hlopt{$}\hlstd{op,} \hlkwc{ref} \hlstd{=} \hlstr{"n"}\hlstd{)}
\hlstd{> }
\hlstd{> }\hlcom{# glmm3 <- lmer(projective ~ verb * op + (1 | workerid) +}
\hlstd{> }\hlcom{#                  (1 | content), data=data)}
\hlstd{> }\hlcom{# }
\hlstd{> }\hlcom{# save.image("../../../results/main/meta-analyses/projectivity/rscripts/linear-models.RData")}
\hlstd{> }\hlkwd{load}\hlstd{(}\hlstr{"../../../results/main/meta-analyses/projectivity/rscripts/linear-models.RData"}\hlstd{)}
\hlstd{> }\hlkwd{print}\hlstd{(}\hlkwd{summary}\hlstd{(glmm3),} \hlkwc{cor}\hlstd{=F,} \hlkwc{dig}\hlstd{=}\hlnum{3}\hlstd{)}
\end{alltt}
\begin{verbatim}
Linear mixed model fit by REML. t-tests use Satterthwaite's method [
lmerModLmerTest]
...
\hlstd{> }\hlstd{data}\hlopt{$}\hlstd{op} \hlkwb{<-} \hlkwd{relevel}\hlstd{(data}\hlopt{$}\hlstd{op,} \hlkwc{ref} \hlstd{=} \hlstr{"n"}\hlstd{)}
\hlstd{> }
\hlstd{> }\hlcom{# glmm6 <- lmer(projective ~ op * verb + (1 | workerid) +}
\hlstd{> }\hlcom{#                  (1 | content), data=data)}
\hlstd{> }
\hlstd{> }\hlcom{# save.image("../../../results/main/meta-analyses/projectivity/rscripts/linear-models.RData")}
\hlstd{> }\hlcom{# load("../../../results/main/meta-analyses/projectivity/rscripts/linear-models.RData")}
\hlstd{> }\hlkwd{print}\hlstd{(}\hlkwd{summary}\hlstd{(glmm6),} \hlkwc{cor}\hlstd{=F,} \hlkwc{dig}\hlstd{=}\hlnum{3}\hlstd{)}
\end{alltt}
\begin{verbatim}
Linear mixed model fit by REML. t-tests use Satterthwaite's method [
lmerModLmerTest]
Formula: projective ~ op * verb + (1 | workerid) + (1 | content)
   Data: data

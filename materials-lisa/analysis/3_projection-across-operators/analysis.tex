...
\hlstd{> }
\hlstd{> }\hlstd{glmm2a} \hlkwb{<-} \hlkwd{lmer}\hlstd{(projective} \hlopt{~} \hlstd{verb} \hlopt{*} \hlstd{op} \hlopt{+} \hlstd{(}\hlnum{1} \hlopt{|} \hlstd{workerid)} \hlopt{+}
\hlstd{+ }                 \hlstd{(}\hlnum{1} \hlopt{|} \hlstd{content),} \hlkwc{data}\hlstd{=data)}
\hlstd{> }
\hlstd{> }\hlcom{# save.image("../../../results/main/meta-analyses/projectivity/rscripts/linear-models.RData")}
\hlstd{> }\hlkwd{load}\hlstd{(}\hlstr{"../../../results/main/meta-analyses/projectivity/rscripts/linear-models.RData"}\hlstd{)}

...
\pagebreak
\section{Experiments with Conditionals} % (fold)
	...
	% subsection 1c_conditional_ (end)
	...
	% subsection 3c_conc (end)

% section experiments_with_conditionals (end)



\section{Some more notes} % (fold)
	
	\subsection{At-issueness diagnostics} % (fold)
	...
	% subsection at_issueness_diagnostics (end)

% section some_more_notes (end)

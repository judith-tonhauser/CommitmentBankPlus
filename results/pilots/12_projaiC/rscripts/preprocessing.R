# 12_projaiC
# conditional: projection and at-issueness (assent with adversative continuation)
# preprocessing
...
round(mean(d.MC.Proj$response),2) #.94 (because speaker is not committed to content of questions)
...
round(mean(d.MC.AI$response),2) #.67 (because main clause content is at-issue, coded as 0)

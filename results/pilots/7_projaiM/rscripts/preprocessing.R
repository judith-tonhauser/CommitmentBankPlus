# 7_projaiM
# modal: projection and at-issueness (assent with positive continuation)
# preprocessing
...
round(mean(d.MC.Proj$response),2) #.97
...
round(mean(d.MC.AI$response),2) #.31 (because main clause content is at-issue, coded as 0)

# 8_projaiC_b (second pilot: first one had past tense predicates)
...
round(mean(d.MC.Proj$response),2) #.92 (because speaker is not committed to content of questions)
...
round(mean(d.MC.AI$response),2) #.26 (because main clause content is at-issue, coded as 0)

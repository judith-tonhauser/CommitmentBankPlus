# 5_projaiQ
# question: projection and at-issueness (assent with positive continuation)
# preprocessing
...
round(mean(d.MC.Proj$response),2) #.13 (because speaker is not committed to content of questions)
...
round(mean(d.MC.AI$response),2) #.05 (because main clause content is at-issue, coded as 0)

...
//    },
   {
     "trigger":"be_annoyed",
     "trigger_class":"C",
     "continuation":"is annoyed about it"
   }, 
   {
     "trigger":"discover",
     "trigger_class":"C",
     "continuation":"discovered it"
   }, 
   {
     "trigger":"know",
     "trigger_class":"C",
     "continuation":"knows it"
   }, 
   {
     "trigger":"reveal",
     "trigger_class":"C",
      "continuation":"revealed it"
   },
   {
     "trigger":"see",
     "trigger_class":"C",
   ...
   },
   {
     "trigger":"pretend",
     "trigger_class":"C",
      "continuation":"pretended it"
   }, 
   {
     "trigger":"suggest",
     "trigger_class":"C",
    "continuation":"suggested it"
   }, 
   {
     "trigger":"say",
     "trigger_class":"C",
    "continuation":"said it"
   }, 
   {
     "trigger":"think",
     "trigger_class":"C",
    "continuation":"thought it"
   },
   {
     "trigger":"be_right",
     "trigger_class":"C",
    "continuation":"is right about it"
   },
   {
     "trigger":"demonstrate",
     "trigger_class":"C",
     "continuation":"demonstrated it"
   },
   {
     "trigger":"acknowledge",
     "trigger_class":"C",
     "continuation":"acknowledged it"
   },
   {
     "trigger":"admit",
     "trigger_class":"C",
     "continuation":"admitted it"
   },
   {
     "trigger":"announce",
     "trigger_class":"C",
     "continuation":"announced it"
   },
   {
     "trigger":"confess",
     "trigger_class":"C",
     "continuation":"confessed it"
   },
   {
     "trigger":"confirm",
     "trigger_class":"C",
     "continuation":"confirmed it"
   },
   {
     "trigger":"establish",
     "trigger_class":"C",
     "continuation":"established it"
   },
   {
     "trigger":"hear",
     "trigger_class":"C",
      "continuation":"heard it"
   },
   {
     "trigger":"inform",
     "trigger_class":"C",
     "continuation":"informed Sam about it"
   },
   {
     "trigger":"prove",
     "trigger_class":"C",
     "continuation":"proved it"
   }
 ]);
 ...
 var contents = {
   "mary": {
     ...
     "pretend_continuation": "pretended that she is",
     "think_continuation":"thinks that she is",
   ...
   "josie": {
     ...
     "subject":"Sarah",
      ...
      "pretend_continuation":"pretended that she did",
     "think_continuation":"thinks that she did",
   ...
   "olivia": {
    ...
    "pretend_continuation":"pretended that she does",
     "think_continuation":"thinks that she does",
   ...
   "danny": {
     ...
     "subject":"Kathryn",
      ...
      "pretend_continuation":"pretended that he did",
     "think_continuation":"thinks that he did",
   ...
   "julian": {
     ...
     "pretend_continuation":"pretended that he does",
     "think_continuation":"thinks that he does",

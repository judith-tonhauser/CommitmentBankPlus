...
//	  var utterance = "<table><tr><td><strong>"+this.stim.name + ":</strong> \"<i>"+this.stim.utterance+"</i>\"</td></tr><tr><td><strong>"+this.stim.name2 + ":</strong> \"<i>Are you sure?</i>\""+"</td></tr><tr><td><strong>"+this.stim.name + ": </strong> \"<i>Yes, I'm sure that "+this.stim.question+".</i>\""+"</td></tr></table>"
      ...
      if (this.stim.block == "ai") {
	  		utterance = "<table><tr><td><strong>"+this.stim.name + ":</strong> \"<i>" +this.stim.utterance+"</i>\"</td></tr><tr><td><strong>"+this.stim.name2 + ":</strong> \"<i>Yes, that's true, but " + this.stim.subject + " " + continuation + ".</i>\"";
        // controls: 
...
//    },
   {
     "trigger":"be_annoyed",
     "trigger_class":"C",
     "continuation":"isn't annoyed about it"
   }, 
   {
     "trigger":"discover",
     "trigger_class":"C",
     "continuation":"didn't discover it"
   }, 
   {
     "trigger":"know",
     "trigger_class":"C",
     "continuation":"doesn't know it"
   }, 
   {
     "trigger":"reveal",
     "trigger_class":"C",
      "continuation":"didn't reveal it"
   },
   {
     "trigger":"see",
     "trigger_class":"C",
      "continuation":"didn't see it"
   },
   {
     "trigger":"pretend",
     "trigger_class":"C",
      "continuation":"didn't pretend it"
   }, 
   {
     "trigger":"suggest",
     "trigger_class":"C",
    "continuation":"didn't suggest it"
   }, 
   {
     "trigger":"say",
     "trigger_class":"C",
    "continuation":"didn't say it"
   }, 
   {
     "trigger":"think",
     "trigger_class":"C",
    "continuation":"doesn't think it"
   },
   {
     "trigger":"be_right",
     "trigger_class":"C",
    "continuation":"isn't right about it"
   },
   {
     "trigger":"demonstrate",
     "trigger_class":"C",
     "continuation":"didn't demonstrate it"
   },
   {
     "trigger":"acknowledge",
     "trigger_class":"C",
     "continuation":"didn't acknowledge it"
   },
   {
     "trigger":"admit",
     "trigger_class":"C",
     "continuation":"didn't admit it"
   },
   {
     "trigger":"announce",
     "trigger_class":"C",
     "continuation":"didn't announce it"
   },
   {
     "trigger":"confess",
     "trigger_class":"C",
     "continuation":"didn't confess it"
   },
   {
     "trigger":"confirm",
     "trigger_class":"C",
     "continuation":"didn't confirm it"
   },
   {
     "trigger":"establish",
     "trigger_class":"C",
     "continuation":"didn't establish it"
   },
   {
     "trigger":"hear",
     "trigger_class":"C",
      "continuation":"didn't hear it"
   },
   {
     "trigger":"inform",
     "trigger_class":"C",
     "continuation":"didn't inform Sam about it"
   },
   {
     "trigger":"prove",
     "trigger_class":"C",
     "continuation":"didn't prove it"
   }
 ]);
 ...
 var contents = {
   "mary": {
     ...
     "pretend_continuation": "didn't pretend that she is",
     "think_continuation":"doesn't think that she is",
   ...
   "josie": {
     ...
     "subject":"Sarah",
      ...
      "pretend_continuation":"didn't pretend that she did",
     "think_continuation":"doesn't think that she did",
   ...
   "olivia": {
    ...
    "pretend_continuation":"didn't pretend that she does",
     "think_continuation":"doesn't think that she does",
  ...
  "be_annoyed":"Perhaps Andrea is annoyed that Isabella ate a steak on Sunday.",
   ...
   "danny": {
     ...
     "subject":"Kathryn",
      ...
      "pretend_continuation":"didn't pretend that he did",
     "think_continuation":"doesn't think that he did",
   ...
   "julian": {
     ...
     "pretend_continuation":"didn't pretend that he does",
     "think_continuation":"doesn't think that he does",

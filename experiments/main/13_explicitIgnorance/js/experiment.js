...
//     	inst1 = inst1 + "Please rate whether the statements are natural."
//     	$("#inst1").html(inst1);
//     },
//     button : function() {
//       exp.go(); //use exp.go() if and only if there is no "present" data.
...
//	  var utterance = "<table><tr><td><strong>"+this.stim.name + ":</strong> \"<i>"+this.stim.utterance+"</i>\"</td></tr><tr><td><strong>"+this.stim.name2 + ":</strong> \"<i>Are you sure?</i>\""+"</td></tr><tr><td><strong>"+this.stim.name + ": </strong> \"<i>Yes, I'm sure that "+this.stim.question+".</i>\""+"</td></tr></table>"
      utterance = "<table><tr><td><strong>"+this.stim.name + ":</strong> \"<i>I have no idea whether " +this.stim.question + ". " +this.stim.utterance+"</i>\"</td></tr><tr><td><strong>";
	  ...
	  question = "Does "+this.stim.name+"'s utterance sound natural?";
...
// 2 of the main clause items are controls (expect high naturalness rating, 
// use these to remove participants' data)
// 3 of the main clause items are supposed hard triggers: also, too, it-cleft
// 1 of the main clause items also does not seem cancelable: possessive NP
var mcitems = {
  "muffins": {
    "question":"these muffins have blueberries in them",
    "MCq":"Do these muffins also have chocolate in them?",
  ...
  "kids": {
    "question":"anyone was playing outside with the kids",
    "MCq":"Was it Jack who was playing outside with the kids?",
...
"ballet": {
    ...
    "MCq":"Does Candy dance ballet, too?",
    // "MCq":"Does Ann dance ballet?",
    "MCa":"Ann dances ballet."},
"garage": {
    "question":"John has kids",
...
//		}
  ...
  exp.structure=["botcaptcha", "i0", "block1", 'questionaire', 'finished'];
